...
![The AI Node Catalog, with each node's type, category, branching and enabled state](/images/admin/ai-node-catalog.png)
...
![The Edit Node panel, with the editable purpose and the read-only code-derived fields](/images/admin/ai-node-edit.png)
