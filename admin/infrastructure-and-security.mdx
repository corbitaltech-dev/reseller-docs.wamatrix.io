...
<CardGroup cols={2}>
  <Card title="reCAPTCHA" icon="shield" href="/admin/onboarding-a-sub-tenant#bot-protection">
...
<Frame caption="The Google Accounts tab, with the client credentials and the redirect URI to register">
  <img src="/images/admin/google-accounts.png" alt="The Google Accounts tab, with the client credentials and the redirect URI to register" />
</Frame>
