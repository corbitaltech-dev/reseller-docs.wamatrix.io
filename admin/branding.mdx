...
<Frame caption="The System Core Settings page, with the site name, locale defaults, and the logo and favicon upload fields">
  <img src="/images/admin/system-core-settings.png" alt="The System Core Settings page, with the site name, locale defaults, and the logo and favicon upload fields" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Logos & favicon">
    ...
    The **Dark Logo** is used in dark mode. The **Favicon** is shown in the browser tab.

    Supported formats are **JPEG, PNG, and WebP** for logos. **ICO** is also supported for the Favicon.

    You can select an existing file from the [**Media Library**](/admin/media-library) by clicking **Add Media**.
  </Tab>
</Tabs>
...
<Frame caption="The Email Layout page on its Branding tab, with the live email preview alongside">
  <img src="/images/admin/email-layout.png" alt="The Email Layout page on its Branding tab, with the live email preview alongside" />
</Frame>
...
<Tabs>
  <Tab title="Branding">
    Configure the logo shown in the email header. If no logo is selected, the **Site Logo** is used.
  </Tab>
  <Tab title="Colours">
...
Go to **Settings → Email** and enable the **Enable Email** switch to activate email sending.

<Frame caption="The Email Configuration page, with the SMTP connection fields, sender identity, and the Send Test Email box">
  <img src="/images/admin/smtp-settings.png" alt="The Email Configuration page, with the SMTP connection fields, sender identity, and the Send Test Email box" />
</Frame>
...
<Frame caption="The Legal settings page, with the Privacy Policy and Terms & Conditions link fields">
  <img src="/images/admin/legal-settings.png" alt="The Legal settings page, with the Privacy Policy and Terms & Conditions link fields" />
</Frame>
...
<Frame caption="The tenant sign-up page, with Terms of Service and Privacy Policy shown as links beside the agreement checkbox">
  <img src="/images/admin/signup-consent-links.png" alt="The tenant sign-up page, with Terms of Service and Privacy Policy shown as links beside the agreement checkbox" />
</Frame>
