...
<Frame caption="The Invoices list, with each invoice's status, amount, and payment method">
  <img src="/images/admin/invoices-list.png" alt="The Invoices list, with each invoice's status, amount, and payment method" />
</Frame>
...
<Frame caption="An invoice's detail page, with its details, the tenant, the pricing breakdown, and line items">
  <img src="/images/admin/invoice-detail.png" alt="An invoice's detail page, with its details, the tenant, the pricing breakdown, and line items" />
</Frame>
...
<Frame caption="The Payments list, showing captured and failed attempts with their reference and method">
  <img src="/images/admin/payments-list.png" alt="The Payments list, showing captured and failed attempts with their reference and method" />
</Frame>
