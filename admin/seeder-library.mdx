...
<Frame caption="The Seeder Library list, with each collection's type, source and availability switch">
  <img src="/images/admin/seeder-library-list.png" alt="The Seeder Library list, with each collection's type, source and availability switch" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Add Collection">
    ...
    <Frame caption="The Add Collection panel, with the seeder key, type, flow JSON and availability switch">
      <img src="/images/admin/seeder-add-collection.png" alt="The Add Collection panel, with the seeder key, type, flow JSON and availability switch" />
    </Frame>
  ...
  <Tab title="Import">
    ...
    <Frame caption="The Import page, with the upload area and the required and optional fields">
      <img src="/images/admin/seeder-import.png" alt="The Import page, with the upload area and the required and optional fields" />
    </Frame>
