...
<Frame caption="The WhatsApp tab, with the Meta app credentials and Embedded Signup switches">
  <img src="/images/admin/channels-whatsapp-credentials.png" alt="The WhatsApp tab, with the Meta app credentials and Embedded Signup switches" />
</Frame>
...
<Frame caption="The Webhook Configuration card, with the webhook URL and Connect Webhook button">
  <img src="/images/admin/channels-whatsapp-webhook.png" alt="The Webhook Configuration card, with the webhook URL and Connect Webhook button" />
</Frame>
...
<Frame caption="The Shopify tab, with the URLs to register, API credentials and OAuth scopes">
  <img src="/images/admin/channels-shopify.png" alt="The Shopify tab, with the URLs to register, API credentials and OAuth scopes" />
</Frame>
