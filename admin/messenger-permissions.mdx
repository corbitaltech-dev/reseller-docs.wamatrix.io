...
| **Verified Business Portfolio** | Business Verification is required for Advanced Access. See [Tech Provider Approval](/admin/tech-provider-approval#complete-tech-provider-onboarding). |
...
<Steps>
  <Step title="Create or reuse a Meta app" icon="plus">
    ...
    <Frame caption="The Create an app use cases step, with Engage with customers on Messenger selected">
      <img src="/images/admin/messenger-create-app-use-case.png" alt="The Create an app use cases step, with Engage with customers on Messenger selected" />
    </Frame>
    ...
    <Frame caption="The Publishing requirements step, listing Business verification, Access verification and App Review">
      <img src="/images/admin/messenger-publishing-requirements.png" alt="The Publishing requirements step, listing Business verification, Access verification and App Review" />
    </Frame>
  ...
  <Step title="Create a Facebook Login for Business configuration" icon="log-in">
    ...
    Save and copy the **Configuration ID**. It goes into [**Settings → Channels → Messenger → Embedded Signup Config ID**](/admin/channels#messenger).
  </Step>
  ...
  <Step title="Enter credentials and connect the webhook" icon="webhook">
    ...
    <Frame caption="The Messenger tab, with the Meta app credentials and connection switches">
      <img src="/images/admin/channels-messenger.png" alt="The Messenger tab, with the Meta app credentials and connection switches" />
    </Frame>
  </Step>
