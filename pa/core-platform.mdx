...
<Tabs>
  <Tab title="Email Alerts">
    ...
    <Note>
      **Plan Limit Almost Reached** applies to your own plan. Alerts for your tenants are set separately under [Customer Plan Limit Alerts](/pa/onboarding-a-sub-tenant#customer-plan-limit-alerts).
    </Note>
  </Tab>
