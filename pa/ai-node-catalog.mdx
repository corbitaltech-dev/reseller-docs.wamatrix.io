...
<Frame caption="The AI Node Catalog, with each node's type, category, branching and enabled state">
  <img src="/images/pa/ai-node-catalog.png" alt="The AI Node Catalog, with each node's type, category, branching and enabled state" />
</Frame>
...
<Frame caption="The Edit Node panel, with the editable purpose and the read-only code-derived fields">
  <img src="/images/pa/ai-node-edit.png" alt="The Edit Node panel, with the editable purpose and the read-only code-derived fields" />
</Frame>
