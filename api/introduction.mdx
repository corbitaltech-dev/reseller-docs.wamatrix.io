---
title: "WaMatrix Reseller REST API — Reference and Quick Start"
sidebarTitle: "API Overview"
description: "Explore the WaMatrix REST API to manage client workspaces, send WhatsApp messages, sync contacts, and run broadcast campaigns at scale."
---
