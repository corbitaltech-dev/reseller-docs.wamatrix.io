---
title: "API Authentication — Keys, Scopes, and Bearer Tokens"
sidebarTitle: "Authentication"
description: "Learn how to generate WaMatrix API keys in your Reseller dashboard and pass them as Bearer tokens to authenticate every API request."
---
